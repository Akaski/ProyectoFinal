...
namespace Negocio
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="dbclinica")]
    ...
    partial void OntelefonoChanged();
		...
		[Column(Storage="_idcliente", AutoSync=AutoSync.Always, DbType="Int NOT NULL IDENTITY", IsDbGenerated=true)]
		...
		[Column(Storage="_nombre", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ap_paterno", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ap_materno", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ci", DbType="VarChar(30) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string ci
		{
			get
			{
		...
		[Column(Storage="_telefono", DbType="VarChar(200)")]
		...
		[Association(Name="Cliente_DetalleTrabajo", Storage="_DetalleTrabajo", ThisKey="ci", OtherKey="idcliente")]
    ...
    partial void OnmontoChanged();
		...
		[Column(Storage="_idtrabajo", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_descripcion", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_costo", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string costo
		{
			get
			{
		...
		[Column(Storage="_idcliente", DbType="VarChar(30) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_hora", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string hora
		{
			get
			{
		...
		[Column(Storage="_nropago", DbType="Int NOT NULL")]
		public int nropago
		{
			get
			{
		...
		[Column(Storage="_monto", DbType="Int NOT NULL")]
		public int monto
		{
			get
			{
		...
		[Association(Name="Cliente_DetalleTrabajo", Storage="_Cliente", ThisKey="idcliente", OtherKey="ci", IsForeignKey=true)]
		...
		[Association(Name="trabajo_DetalleTrabajo", Storage="_trabajo", ThisKey="idtrabajo", OtherKey="idtrabajo", IsForeignKey=true)]
    ...
    partial void OnprecioChanged();
		...
		[Column(Storage="_idtrabajo", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int idtrabajo
		{
			get
			{
		...
		[Column(Storage="_precio", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="trabajo_DetalleTrabajo", Storage="_DetalleTrabajo", ThisKey="idtrabajo", OtherKey="idtrabajo")]
		public EntitySet<DetalleTrabajo> DetalleTrabajo
		{
			get
			{

...
namespace SistemaClinica
{
    public partial class FrmDetalle : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'dataSet1.DetalleTrabajo' Puede moverla o quitarla según sea necesario.
            this.detalleTrabajoTableAdapter.Fill(this.dataSet1.DetalleTrabajo);
            tmrRefesh.Start();
        }
